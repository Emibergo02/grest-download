const DownloadPDF = ({size, pages, fileName, link}: {
    size: number,
    pages: number,
    fileName: string,
    link: string
    ...
    return (
        <a href={link}
           className="flex items-start bg-gray-50 dark:bg-gray-700 rounded-xl p-2 m-1 hover:bg-gray-100 focus:ring-2 focus:outline-none dark:text-white focus:ring-gray-50 dark:hover:bg-gray-600 dark:focus:ring-gray-600"
           type="button">
            <div className="me-2">
