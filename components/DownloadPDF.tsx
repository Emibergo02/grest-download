const DownloadPDF = ({fileName,link}:{fileName: string,link: string}) => {
  return (
          <a href={link} className="flex items-start bg-gray-50 dark:bg-gray-700 rounded-xl p-2 m-1 hover:bg-gray-100 focus:ring-2 focus:outline-none dark:text-white focus:ring-gray-50 dark:hover:bg-gray-600 dark:focus:ring-gray-600" type="button">
              <div className="me-2">
               <span className="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white pb-2">
                  ...
                  12 Pages
                  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="self-center" width="3"
              ...
              <div className="inline-flex self-center items-center">
                  <svg className="w-6 h-6 text-gray-900 dark:text-white" aria-hidden="true"
